        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><div id="mtButton"><button type="button" class="btn btn-default btn-lg" style="border: 0;"><img src="{{ URL::to('/images/voff.png') }}" alt="Mute" style="margin-top: 3px;"/></button></div></li>
